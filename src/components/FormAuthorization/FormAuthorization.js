...
export default class FormAuthorization extends PureComponent<NavigationScreenProps> {
              ...
              <View>
                  ...
                  }
                  {
                      ...
                      ? <HelperText
                          type="error"
                          style={errorInput}
                          visible={errorLogin}>Введите логин!</HelperText>
                      : null
                  }
                  <View style={viewInput}>
                      <Icon
                  ...
                  <HelperText
                      type="error"
                      style={errorInput}
                      visible={errorEmail}>Введите адрес электронной почты!</HelperText>
                  <View style={viewInput}>
                      <Icon
                          name='lock'
                          color={DEEP_BLUE}
                  ...
                  <HelperText
                      type="error"
                      style={errorInput}
                      visible={errorPassword}>Введите пароль!</HelperText>
              </View>
              <TouchableOpacity
                  activeOpacity={0.8}
                  style={button}
